...
# Strings are immutable: every method returns a NEW string, never modifies
# the original.
# =============================================================================
...
# → 5   like find(), but raises ValueError if missing
print(text.index("at"))
...
# → ["hello", "world"]  splits on any whitespace, no empties
print("  hello  world  ".split())

# → ["hello", "world"]  split from the right
...
# → "hello world"      concatenation (use join for many strings)
print("hello" + " world")
print(len("hello"))        # → 5
